             ...
             <div class="container-fluid p-4">
                ...
                <div class="tab-content">
                    <div class="row">
                        ...
                        <?php
                        $query = "SELECT * FROM folders WHERE user_id='1' AND Folder_type='Off-boarding'";
                            ...
                            while($row = mysqli_fetch_assoc($run)){
                                ...
                                <div class="card  mb-4 card-hover">
                                    <div class=" card-img-top mt-2 d-flex ">
                                        <a href="offboarding_templates.php?foldersub=<?php echo $row['id'];?>" class="d-flex w-100 justify-content-center">
                                    ...
                                    <div class="card-body">
                                        <h3 class="h4 mb-2 text-truncate-line-2 text-center">
                                            <a href="offboarding_templates.php?foldersub=<?php echo $row['id'];?>" class="text-inherit"><?php echo $row['name']?></a>
                                        </h3>      
                                    </div>
                                </div> 
                            </div>
                ...
                <form action="offboarding_folder.php" method="POST">
                    ...
                    <div class="form-group mb-2">
                        <label class="form-label" for="title">Folder Type<span
                                class="text-danger">*</span></label>
                        <input type="text" class="form-control"
                                name="foldertypetextbox" value="Off-Boarding" id = "foldertypetextbox" required>
                    </div>
                    <div>
