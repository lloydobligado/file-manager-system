    ...
    <div class="modal-dialog modal-dialog-centered modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <button type="button" onclick="location.href='onboarding_templates.php?foldersub=<?php  echo $folder;?>'" class="btn-close" data-dismiss="modal"
                    aria-label="Close">
                    <span aria-hidden="true"><i class="fe fe-x-circle"></i></span>
                </button>
            </div>
            <div class="modal-body">
                <form action="onboarding_folder.php?filesub=<?php echo $_GET['filesub'];?>" method="POST">
                    ...
                    <div>
                        ...
                        <input type="button" onclick="location.href='onboarding_templates.php?foldersub=<?php  echo $folder;?>'" type="button" class="btn btn-outline-white" value="Close">
                        </input>
                    </div>
                </form>
            </div>
