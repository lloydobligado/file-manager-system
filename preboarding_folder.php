<?php
                ...
                $rowsss = mysqli_num_rows($queryyy);                
                    if($rowsss > 0){
                        ...
                        $folder = $row['folder_id'];
                         echo'<script type = "text/javascript"> alert("Name already exists!"); window.location.href = "preboarding_templates.php?foldersub='.$folder.'";</script>';
                    }
                    else{
                        ...
                        $run1 = mysqli_query($db,$query1);
                            if($run1){
                                ...
                                $row = mysqli_fetch_assoc($queryyy);
                                $folder = $row['folder_id'];
                                    echo'<script type = "text/javascript"> alert("File Renamed Successfully!"); window.location.href = "preboarding_templates.php?foldersub='.$folder.'";</script>';
                            }
                             else{
                                    echo'<script type = "text/javascript"> alert("Failed to rename file."); window.location.href = "preboarding_templates.php?foldersub='.$folder.'";</script>';
                            }
                    }
            }
            else{    
    ...
    if(isset($_POST['newfolder'])){
        ...
        elseif(empty($foldername)){
            ...
            $rowsss = mysqli_num_rows($queryyy);
            if($rowsss > 0){
            echo'<script type = "text/javascript"> alert("Folder name already exists."); window.location.href = "preboarding.php";</script>';
                ...
                if($run1){
                    echo'<script type = "text/javascript"> alert("Folder Created Successfully!"); window.location.href = "preboarding.php";</script>';
                    
                }
                else{
                    echo'<script type = "text/javascript"> alert("Failed to create."); window.location.href = "preboarding.php";</script>';
    ...
    if(isset($_POST['editfolder'])){
        ...
        elseif(empty($oldername)){
            echo'<script type = "text/javascript"> alert("Fields cannot be empty!"); window.location.href = "preboarding.php";</script>';
            ...
            $run1 = mysqli_query($db,$query1);
                ...
                if($run1){
                    echo'<script type = "text/javascript"> alert("Folder Renamed Successfully!"); window.location.href = "preboarding.php";</script>';
                    
                }
                else{
                    echo'<script type = "text/javascript"> alert("Failed to rename folder."); window.location.href = "preboarding.php";</script>';
    ...
    if(isset($_POST['deletefolder'])){
        ...
        elseif(empty($deletefolder)){
            ...
            if($rowsss > 0){
                ...
                $run1 = mysqli_query($db,$query1);
                if($run1){
                    echo'<script type = "text/javascript"> alert("Folder Deleted Successfully!"); window.location.href = "preboarding.php";</script>';                    
                }
                else{
