                            ...
                            while($row = mysqli_fetch_assoc($run)){
                                ...
                                <div class="card  mb-4 card-hover">
                                    <div class=" card-img-top mt-2 d-flex ">
                                        <a href="preboarding_templates.php?foldersub=<?php echo $row['id'];?>" class="d-flex w-100 justify-content-center">
                                    ...
                                    <div class="card-body">
                                        <h3 class="h4 mb-2 text-truncate-line-2 text-center">
                                            <a href="preboarding_templates.php?foldersub=<?php echo $row['id'];?>" class="text-inherit"><?php echo $row['name']?></a>
                                        </h3>      
                                    </div>
                                </div> 
                            </div>
